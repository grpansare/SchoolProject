...
public class English extends Question {
	...
	public English(String quename, String option1, String option2, String option3, String option4,
	...
	public String toString() {
		return "English [qid=" + qid + ", Subject=" + Subject + ", quename=" + quename + ", option1=" + option1
