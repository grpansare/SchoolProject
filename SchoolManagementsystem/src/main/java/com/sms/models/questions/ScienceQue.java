...
public class ScienceQue extends Question {
	...
	public ScienceQue(String quename, String option1, String option2, String option3, String option4,
	...
	public String toString() {
		return "ScienceQue [qid=" + qid + ", Subject=" + Subject + ", quename=" + quename + ", option1=" + option1
